...
const Footer = () => {
  return (
    <>
      <footer className="">
        <div className="f1 border-t-1 border-t-[#E7E7E7] border-b-1 border-b-[#E7E7E7] py-15">
          <div className="container flex items-center justify-between flex-wrap px-10">
              ...
              <div className="logo">
                ...
                <div className="items mt-5 flex flex-col gap-3">
                  <Link to={"/"} className="item-1 flex items-center gap-2">
                    ...
                    <p className="text-[16px] text-[#4B5563] font-normal font-popppind">
                      Facebook
                    </p>
                  </Link>
                  <Link to={"/"} className="item-1 flex items-center gap-2">
            ...
            <div className="col-2 mt-15 lg:mt-0">
              <div className="logo">
                <h3 className="text-[16px] text-[#111827] font-semibold font-popppind">
                  Getting started
                </h3>
        ...
        <div className="f2 py-9 container lg:flex  items-center justify-between">
          <div className="text">
            <p className="text-sm lg:text-[16px] text-[#4B5563] font-normal font-popppind text-center pb-3">

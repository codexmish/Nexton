        ...
        <div className="container">
          <div className="product-row flex justify-between flex-wrap px-3 lg:px-0">
            ...
            <div className="product-opt w-[312px] lg:w-[460px] p-2 lg:p-8 lg:border border-[#E5E7EB] rounded-2xl h-fit">
              <h2 className="text-2xl text-primary font-semibold font-popppind lg:hidden">Black Automatic Watch</h2>
              <div className="flex justify-between items-start flex-wrap mt-3">
                <div className="flex items-center gap-1 order-2 lg:order-0 w-[300px]">
                  ...
                  <p className="text-[12px] lg:text-base text-secoundary font-semibold font-popppind">
                    4.9 <span className="hidden lg:inline-block">. 142 reviews </span> <span className="lg:hidden">(98)</span>
                  </p>
                </div>
          ...
          <div className="mt-[108px] flex flex-col gap-15 px-3 lg:px-0">
            <div>
            <h2 className="text-4xl text-primary font-semibold font-popppind hidden lg:block">Black Automatic Watch</h2>
            <h2 className="text-[20px] lg:text-4xl text-primary font-semibold font-popppind lg:hidden">About this product</h2>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">The St. Louis Meramec Canoe Company was founded by Alfred Wickett in 1922. Wickett had previously worked for the Old Town Canoe Co from 1900 to 1914. Manufacturing of the classic wooden canoes in Valley Park, Missouri ceased in 1978.</p>

            </div>

            <div>
            <h2 className="text-[20px] lg:text-4xl text-primary font-semibold font-popppind">Fabric + Care</h2>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">Material: Soft wool blend</p>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">Color: Various</p>

            </div>

            <div>
            <h2 className="text-[20px] lg:text-4xl text-primary font-semibold font-popppind">Sale performance</h2>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">Sales: 0</p>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">Review Count: -</p>
            <p className="text-sm lg:text-base text-secoundary font-normal font-popppind max-w-[735px] mt-1">Review Average: -</p>

            </div>

            <div>
            <h2 className="text-[20px] lg:text-4xl text-primary font-semibold font-popppind">Keywords</h2>
